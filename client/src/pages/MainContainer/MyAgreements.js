...
class MyAgreements extends React.Component{
					...
					<div className='rightsidebar_content' style={{width:'100%', display:'flex', marginTop: 30}}>
						<div className='rightsidebar_item'>
							...
							<FilePond
								...
								onupdatefiles={(e)=>{this.setState({file1: e})}}
						...
						<div className='rightsidebar_item' style={{marginTop: 20}}>
							...
							<FilePond
								...
								onupdatefiles={(e)=>{this.setState({file2: e})}}
								allowImagePreview={false}
								allowMultiple={false}
								name="files"
								labelIdle={`<div><p style="display: flex; justify-content:'center'; align-items:'center'; text-align:'center'; margin-bottom: 0px; font-size: 16px;">Drag & Drop File<br/> or</p><p style="color: #3DAEEE; display: flex; justify-content: center; align-items: center' text-align: center, font-size: 14px'; cursor: pointer;">Browse Files</p></div>`}
						...
						<div className='rightsidebar_item' style={{marginTop: 20}}>
							...
							<FilePond
								...
								onupdatefiles={(e)=>{this.setState({file3: e})}}
								allowImagePreview={false}
								allowMultiple={false}
								name="files"
								labelIdle={`<div><p style="display: flex; justify-content:'center'; align-items:'center'; text-align:'center'; margin-bottom: 0px; font-size: 16px;">Drag & Drop File<br/> or</p><p style="color: #3DAEEE; display: flex; justify-content: center; align-items: center' text-align: center, font-size: 14px'; cursor: pointer;">Browse Files</p></div>`}
						...
						<div style={{display:'flex', alignItems:'center', marginTop: 20}}>
							<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M13.5 16.5L18 21L33 6" stroke="#3DAEEE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
								<path d="M31.5 18V28.5C31.5 29.2956 31.1839 30.0587 30.6213 30.6213C30.0587 31.1839 29.2956 31.5 28.5 31.5H7.5C6.70435 31.5 5.94129 31.1839 5.37868 30.6213C4.81607 30.0587 4.5 29.2956 4.5 28.5V7.5C4.5 6.70435 4.81607 5.94129 5.37868 5.37868C5.94129 4.81607 6.70435 4.5 7.5 4.5H24" stroke="#3DAEEE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
							</svg>
							<p className="checkbox_text">I confirm that the above uploaded documents are valid.</p>
						</div>
