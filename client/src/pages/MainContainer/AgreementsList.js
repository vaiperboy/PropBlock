						...
						<table class="" aria-label="simple table">
							...
							<tbody class="">
								...
								<tr class="" onClick={(e)=>{this.props.toggleAgreementView(2)}}>
									...
									<td class="">Accepted</td>
									<td class="" style={{textAlign:'center'}}>
										<button className='agreement_upload_button' disabled style={{userSelect:'none'}}>
											-
										</button>
									</td>
								</tr>
