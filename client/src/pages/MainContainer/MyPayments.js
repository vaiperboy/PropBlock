		...
		return(
				<div className='rightsidebar_container'>
					...
					<div className='rightsidebar_content' style={{width:'100%', display:'flex', marginTop: 30, height:'auto'}}>
						<div style={{width:'100%', display:'flex', flexDirection:'column',gap:'30px', borderRadius:'8px', padding:'16px', flexWrap:'wrap', justifyContent:'center',alignItems:'center'}}>
							<img src={noPayment} style={{maxWidth:'550px'}}/>
							<p style={{color:'#979797'}}>You have not made any payments yet.</p>
						</div>
					</div>
				</div>
		);
