...
function MyChart() {
	const data = React.useMemo(
	  () => [
		{
		  label: 'Series 1',
		  data: [{ x: 1, y: 24 }, { x: 2, y: 27 }, { x: 3, y: 23 }]
		},
		{
		  label: 'Series 2',
		  data: [{ x: 1, y: 20 }, { x: 2, y: 22 }, { x: 3, y: 18}, { x: 4, y: 22}, { x: 5, y: 18}]
		},
		{
		  label: 'Series 3',
		...
		return(
				<div className='rightsidebar_container'>
					<div style={{width:'100%', display:'flex', justifyContent:'space-between', alignItems:'center'}}>
						<div>
							<p className='rightsidebar_title'>Welcome back, John</p>
						</div>
					</div>
					<div className='rightsidebar_content' style={{width:'100%', display:'flex', marginTop: 30, height:'auto'}}>
						<div className='dashboard_card_container'>
							<div className="dashboard_card" onClick={()=>{this.props.togglePropertiesView(true)}}>
								<div className='dashboard_card_icon'>
									<svg width="41" height="46" viewBox="0 0 41 46" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M1 16.1667L20.5 1L40 16.1667V40C40 41.1493 39.5435 42.2515 38.7308 43.0641C37.9181 43.8768 36.8159 44.3333 35.6667 44.3333H5.33333C4.18406 44.3333 3.08186 43.8768 2.2692 43.0641C1.45655 42.2515 1 41.1493 1 40V16.1667Z" stroke="#555555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
										<path d="M14 44.3337V22.667H27V44.3337" stroke="#555555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
									</svg>
								</div>
								<div className='dashboard_card_text'>
									My Properties
								</div>
							</div>
							<div className="dashboard_card" onClick={()=>{this.props.toggleStatsView(true)}}>
								<div className='dashboard_card_icon'>
							...
							<div className="dashboard_card"  onClick={()=>{this.props.togglePaymentView(true)}}>
								<div className='dashboard_card_icon'>
									<svg width="23" height="41" viewBox="0 0 23 41" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M11.5 1V39.5" stroke="#555555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
										<path d="M20.25 8H7.125C5.50055 8 3.94263 8.64531 2.79397 9.79397C1.64531 10.9426 1 12.5005 1 14.125C1 15.7495 1.64531 17.3074 2.79397 18.456C3.94263 19.6047 5.50055 20.25 7.125 20.25H15.875C17.4995 20.25 19.0574 20.8953 20.206 22.044C21.3547 23.1926 22 24.7505 22 26.375C22 27.9995 21.3547 29.5574 20.206 30.706C19.0574 31.8547 17.4995 32.5 15.875 32.5H1" stroke="#555555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
									</svg>
								</div>
								<div className='dashboard_card_text'>
									Payments
							...
							<div className="dashboard_card" onClick={()=>{this.props.toggleProfileView(true)}}>
								<div className='dashboard_card_icon'>
									<svg width="30" height="34" viewBox="0 0 30 34" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M29 32.5V29C29 27.1435 28.2625 25.363 26.9497 24.0503C25.637 22.7375 23.8565 22 22 22H8C6.14348 22 4.36301 22.7375 3.05025 24.0503C1.7375 25.363 1 27.1435 1 29V32.5" stroke="#555555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
										<path d="M15 15C18.866 15 22 11.866 22 8C22 4.13401 18.866 1 15 1C11.134 1 8 4.13401 8 8C8 11.866 11.134 15 15 15Z" stroke="#555555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
									</svg>
								</div>
								<div className='dashboard_card_text'>
									Profile
						...
						<div className='dashboard_card_container' style={{flexDirection:'column'}}>
							<div style={{marginTop: 25}}>
								<p className='rightsidebar_subtitle' style={{fontWeight: 500, color: '#555555'}}>Recent Activity</p>
							</div>
							<div className="recent_activity_container">
								<div style={{display:'flex', gap: '15px', justifyContent:'space-between', alignItems:'center', marginLeft: 30}}>
									<div style={{display:'flex', gap: '15px', alignItems:'center'}}>
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M15 6L9 12L15 18" stroke="#242730" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
										</svg>
										<span style={{fontSize: 16}}>2022</span>
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M9 6L15 12L9 18" stroke="#B9B9B9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
										</svg>
									</div>
									<div>
										...
										<svg width="13" height="11" viewBox="0 0 13 11" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<path d="M3.82468 4.25639L6.74541 6.60547L9.66614 4.25639" stroke="#878997" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
											</g>
											<defs>
											<clipPath id="clip0_383_2574">
											<rect width="9.39632" height="11.6829" fill="white" transform="matrix(0 -1 -1 0 12.5869 10.1289)"/>
											</clipPath>
											</defs>
										</svg>
									</div>
								...
								<MyChart />
								<div style={{display:'flex', gap: '10px', justifyContent:'center', marginLeft: 20}}>
									<p className="recent_activity_text">
										<svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
											<ellipse cx="6.08076" cy="7.0666" rx="6.08076" ry="6.8" fill="#3DAEEE"/>
										</svg>
										This Month
									</p>
									<p className="recent_activity_text">
										<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
											<ellipse cx="6.977" cy="7.0666" rx="6.08076" ry="6.8" fill="#FF6589"/>
										</svg>
										Last Month
									</p>
								</div>
