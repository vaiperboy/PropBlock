...
const PurchaseRequests = (props) => {
  ...
  const { Moralis, user, ...rest } = useMoralis();
  useEffect(() => {
    setUserFullName(user.get("fullName"));
  }, []);
      ...
      >
        <div className="dashboard_card_container">
          <div
            ...
            onClick={() => {
              props.togglePropertiesView(true);
            }}
          >
          ...
          <div
            className="dashboard_card"
            onClick={() => {
              props.togglePurchaseRequestView(true);
            }}
          >
            <div className="dashboard_card_icon">
              <svg
