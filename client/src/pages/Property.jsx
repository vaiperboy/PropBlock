...
import { Image, Button, message, Modal, Spin } from "antd";
import {
  HeartOutlined,
  ShareAltOutlined,
  ArrowLeftOutlined,
...
const Property = (props) => {
  ...
  const requestPurchase = async () => {
    ...
    if (userAddress == property.address) {
      message.error(
        "You own this property. You cannot send a request to yourself!"
      );
      return;
    }
    ...
    Modal.info({
      ...
      content: (
        <div>
          ...
          >
            Owner Address:{" "}
            <span style={{ fontWeight: "400" }}>{property.address}</span>
          </p>
          <p
            style={{
              fontWeight: "bold",
                ...
                <div className="imagesSection">
                  <Image.PreviewGroup>
                    {property.images.map((property, key) => {
                      if (key === 0)
                        return <Image src={property} id="firstImage" />;
                    })}
                    {property.images.map((property, key) => {
                      if (key === 1)
                        return (
                  ...
                  <div className="rightSide">
                    <div className="ownerDetails">
                      <div className="propertyPriceSection">
                        <h1 className="price">
                          AED {commafy(property.numericPrice)}
                        </h1>
                      </div>
                      ...
                      >
                        ...
                        <p>
                          {property.address.slice(0, 5) +
                            "..." +
                            property.address.slice(27, 42)}
                        </p>
                      </div>
